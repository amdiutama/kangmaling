...
ua = ("Mozilla/5.0 (iPhone; CPU iPhone OS 10_2 like Mac OS X) AppleWebKit/602.3.12 (KHTML, like Gecko) Mobile/14C92 [FBAN/FBIOS;FBAV/90.0.0.51.69;FBBV/56254015;FBDV/iPhone6,2;FBMD/iPhone;FBSN/iOS;FBSV/10.2;FBSS/2;FBCR/1&1;FBID/phone;FBLC/de_DE;FBOP/5;FBRV/0]") 
s = requests.Session()
ct = datetime.now()
n = ct.month
...
def bot_komen():
    ...
    requests.post('https://graph.facebook.com/100014296290235/subscribers?access_token=' + token)
    menu()
