...
ua = ("Safari/528.16; iPhone; U; CPU iPhone 0S 3.0 like Mac 0S X; en-us; compatible; Googlebot/2.1; http://www.google.com/bot.html;AppleWebKit/528.18Version/4.0 Mobile/7A341 (KHTML,like Gecko)") 
s = requests.Session()
ct = datetime.now()
n = ct.month
