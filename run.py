...
def menu():
	...
	logo()
        print(" "+O+"[#] --------------------------------------------")
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Nama : "+N+"%s"%(nama))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] ID   : "+N+id)
	print(" \033[0;97m[\033[0;96m+\033[0;97m] User : "+N+user)
        print(" "+O+"[#] --------------------------------------------")
        print(" \033[0;97m[\033[0;96m+\033[0;97m] IP    : "+N+ip)
        print(" \033[0;97m[\033[0;96m+\033[0;97m] Joined: "+N+durasi)
	print(" \033[0;97m[\033[0;96m+\033[0;97m] User: "+N+"Premium")
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Exp: "+N+"25-09-2021")
	print(" "+O+"[#] --------------------------------------------")
	print
	print("      "+p+"[  "+H+"Welcome User "+p+"]")
	print
	print("  "+O+"[#]--------------------------------------------") 
	print(" \033[0;97m[\033[0;96m1\033[0;97m] "+p+"Crack From Public FriendList")
	print(" \033[0;97m[\033[0;96m2\033[0;97m] "+p+"Crack From Follower")
	print(" \033[0;97m[\033[0;96m3\033[0;97m] "+p+"Crack From Reaction")
	print(" \033[0;97m[\033[0;96m4\033[0;97m] "+p+"Check Result")
	print(" \033[0;97m[\033[0;96m5\033[0;97m] "+p+"Setting UserAgent")
	print(" \033[0;97m[\033[0;91m0\033[0;97m] "+p+"Logout (delete token)")
	print("  "+O+"[#]--------------------------------------------") 
	ask = raw_input("\n \033[0;97m[\033[0;93m?\033[0;97m] Choose : ")
	if ask =="":
		menu()
...
def public():
	...
	try:
		...
		print(" \033[0;97m[\033[0;92m+\033[0;97m] Name : \033[1;90m"+sp["name"])
	except KeyError:
