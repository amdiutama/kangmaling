...
def menu():
	...
	print(" \n \033[0;97m[\033[0;93m+\033[0;97m] ID   : "+N+id)
	print(" \033[0;97m[\033[0;92m+\033[0;97m] User : "+N+user)
        print(" "+O+"[#] --------------------------------------------")
        print(" \n \033[0;97m[\033[0;93m+\033[0;97m] IP    : "+N+ip)
        print(" \033[0;97m[\033[0;92m+\033[0;97m] Joined: "+N+durasi)
	print(" \033[0;97m[\033[0;92m+\033[0;97m] User: "+N+"Premium")
	print(" \n \033[0;97m[\033[0;93m+\033[0;97m] Exp: "+N+"25-09-2021")
	print(" "+O+"[#] --------------------------------------------")
	print
	print("      "+p+"[  "+H+"Welcome User "+p+"]")
	print
	print("  "+O+"[#]--------------------------------------------") 
	print("\n \033[0;97m[\033[0;93m1\033[0;97m] "+N+"Crack From Public FriendList")
