...
def login():
	...
	try:
		...
		zedd.write(token)
		zedd.close()
		print ('\n\n '+M+'*'+N+' selamat datang %s'%(nama))
		time.sleep(2)
		print (' '+K+' mohon untuk menggunakan sc ini sewajarnya, kami tidak bertanggung jawab jika sc ini disalah gunakan...')
		time.sleep(2)
