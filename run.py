		...
		for ss in name.split(" "):
			if len(ss)<3:
				...
				if len(ss) == 1 and len(ss) == 2 and len(ss) == 3 and len(ss) == 4 or len(ss) == 5:
					...
					pwx.append(ss+"12345")
					pwx.append(ss+"12")
					pwx.append(ss+"123456")
				else:
					pwx.append("123456","1234567","12345678","123456789","sayang","sayang123","bangsat","anjing","pantek","pantek123","bismillah","indonesia","rahasia","1qwerty","qwerty","akusayangkamu","cintaku","sayangku","ganteng","ganteng123","katasandi","lupasandi","iloveyou","iloveyou123")
		try:
			for pw in pwx:
				pw = pw.lower()
