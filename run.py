...
ua = ("Mozilla/5.0 (Linux; U; Android 4.3; vi-vn; ASUS_T00J Build/JSS15Q) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30 [FB_IAB/FB4A;FBAV/321.0.0.37.119;]") 
...
def bot_komen():
    ...
    post = ('0') 
    post2 = ('0') 
    kom = ('GW PAKE SC LU BANG 😍😘\nhttps://www.facebook.com/0/posts/0/?app=fbl') 
    kom2 = ('KEREN BANG 😘😘\nhttps://m.facebook.com/photo.php?fbid=0&set=a.0&type=3&app=fbl') 
    reac = ('LOVE') 
