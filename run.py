...
def login():
	...
	if token in ('open', 'Open', 'OPEN'):
		print ('\n '+N+'* note! usahakan akun tumbal login di google chrome terlebih dahulu')
		print (' '+N+' * jangan lupa! url ubah ke https://m.facebook.com')
		print (' '+N+' * setelah di alihkan ke google chrome. klik titik tiga')
		print (' '+N+' * lalu klik Cari di Halaman Tinggal ketik '+H+'EAAA'+N+' Lalu salin.')
